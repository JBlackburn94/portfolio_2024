...
export default function Skills() {
  return (
    <section className="flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-10 min-h-screen overflow-hidden my-5 mx-10">
      <div className="min-h-[80vh] w-full md:w-[70%] overflow-hidden py-5 px-10">
